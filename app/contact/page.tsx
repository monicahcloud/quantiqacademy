...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-[#f7fafc] px-6 py-28  mt-20 text-[#041f3d]">
      ...
      <div className="relative mx-auto grid max-w-8xl gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
