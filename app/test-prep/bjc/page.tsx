        ...
        <div className="relative mx-auto grid max-w-8xl gap-12 lg:grid-cols-[1fr_420px] lg:items-center">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/10 p-7 shadow-2xl backdrop-blur-xl">
            ...
            <p className="mt-3 leading-7 text-white/70">
              ...
              dashboard and continue through the full learning path.
            </p>

            {isEnrolled && firstLessonId ? (
              <Link
                href={`/learn/lesson/${firstLessonId}`}
        ...
        <div className="mx-auto grid max-w-8xl gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black">
              Build confidence across the core BJC Mathematics strands.
            </h2>

            <p className="mt-5 leading-8 text-slate-600">
              This course is organized around the major junior high mathematics
              areas: number and operations, algebra, geometry and spatial sense,
              measurement, and statistics and probability.
            </p>

            <div className="mt-8 grid gap-4">
              {[
                "Guided lessons by topic",
                "Preview lessons before enrollment",
                "Checkpoint assessments after modules",
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
                ...
                <div key={module.id} className="rounded-3xl bg-slate-50 p-5">
                  <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
                    ...
                    {module.assessmentTitle && (
                      <span className="rounded-full bg-cyan-400/10 px-4 py-2 text-xs font-black uppercase tracking-wide text-cyan-700">
                        {module.assessmentTitle}
                      </span>
                    )}
                  </div>
            ...
            <p className="mt-8 text-sm leading-6 text-slate-500">
              QuantIQ Academy provides independent supplemental preparation and
              is not an official Ministry of Education examination body.
            </p>
          </div>
        </div>
      </section>
